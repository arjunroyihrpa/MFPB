...
class BaseWeightBoosting(six.with_metaclass(ABCMeta, BaseEnsemble)):
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        survived_solutions, survived_sol_idx, self.optimal_solution_set, index_in_complete_solution_set, preference_direction_to_solution_mapping = PreferenceSurvival(preference_vectors).do(self.ob)
